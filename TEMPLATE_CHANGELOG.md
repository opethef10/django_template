...
- Non-existing static file references

## 0.14.1 - 2026-08-08

### Fixed

- ManifestStaticFilesStorage 500 error
## 0.14.0 - 2026-08-08
...
- Template setup and sync script
...
- Infinite 301 loop in Docker production when behind a proxy that does not preserve `X-Forwarded-Proto` (e.g. Cloudflare Tunnel) by dropping the Django-level `SECURE_SSL_REDIRECT`; HTTPS enforcement belongs at the proxy/CDN edge
...
- Volume issue in production docker
...
- Old PythonAnywhere commands like create_wsgi and create_secret_key

## 0.9.1 - 2026-04-06

### Changed

- Example app renamed to docs
- container to container-lg

## 0.9.0 - 2026-04-05

### Added

- General SearchView for modal fuzzy search

### Changed

- Example app endpoint to docs/
