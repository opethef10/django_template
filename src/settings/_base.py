...
ADMIN_SITE_HEADER = config("ADMIN_SITE_HEADER", default=f"{PROJECT_NAME} Administration")
ADMIN_SITE_TITLE = config("ADMIN_SITE_TITLE", default=f"{PROJECT_NAME} Admin")
ADMIN_SITE_INDEX_TITLE = config("ADMIN_SITE_INDEX_TITLE", default=f"Welcome to {PROJECT_NAME}")
